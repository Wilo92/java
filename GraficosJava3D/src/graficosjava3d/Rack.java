...
public final class Rack extends Applet {
    ...
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new Rack(args[0]),850,600);
        else
            new MainFrame(new Rack(null),850,600);
    }
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        try{
           s = file.load(filename == null ? "src\\images\\FinalBaseMesh.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/fondo.jpg",this);
