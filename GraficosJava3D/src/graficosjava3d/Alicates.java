...
public class Alicates extends Applet{
    ...
    private BranchGroup crearEscenarioGrafico(){
        ...
        TextureLoader archivo = new TextureLoader("src/images/fondo.jpg",this);
    ...
    private BranchGroup modelarObjeto(){
        ...
        producto.addChild(cargarObjeto("src\\images\\FinalBaseMesh.obj"));
    ...
    public static void main (String[] args){
        Alicates ejecutar = new Alicates();
