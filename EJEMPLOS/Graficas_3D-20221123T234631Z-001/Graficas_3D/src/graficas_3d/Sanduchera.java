...
public class Sanduchera extends Applet{
    ...
    private BranchGroup crearEscenarioGrafico(){
        ...
        TextureLoader archivo = new TextureLoader("src/imagenes/Fondo3.jpg",this);
    ...
    private BranchGroup modelarObjeto(){
        ...
        transformacion3d.setTranslation(new Vector3d(0.1,-0.1,-1.20)); //define posicion del objeto
        transformacion3d.setScale(0.013); //define el tamaño del objeto
        ...
        producto.addChild(cargarObjeto("src\\imagenes\\sandwichMaker.obj"));
        
        Alpha alpha = new Alpha(-1,20000);
        
        Transform3D eje = new Transform3D();
        eje.setRotation(new AxisAngle4f(1.3f,8.0f,7.0f,8.0f));
        RotationInterpolator girar = new RotationInterpolator(alpha,producto,eje,0.0f,(float) Math.PI*(4.0f));
    ...
    public static void main (String[] args){
        Sanduchera ejecutar = new Sanduchera();
